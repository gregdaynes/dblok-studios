module.exports = (grunt) ->
  ...
  # Default task.
  grunt.registerTask 'default', ['shell:dev', 'jekyll', 'fonts', 'css:dev', 'js:dev', 'media:dev', 'connect', 'watch']
  grunt.registerTask 'dist',    ['shell:dev', 'jekyll', 'fonts', 'css:dist', 'js:dist', 'htmlmin', 'media:dist', 'connect', 'watch']

  grunt.registerTask 'fonts',      ['webfont', 'copy:font']
